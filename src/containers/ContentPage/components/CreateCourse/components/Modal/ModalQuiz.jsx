...
export default function ModalQuiz({ id }) {
  ...
  return (
    <>
      <Button ghost className="btn-none" onClick={() => setModalQuiz(true)}>
        <PlusSquareOutlined /> Quiz
      </Button>
      <Modal
        title="Add Quiz"
        visible={modalQuiz}
                  ...
                  render={({ field }) => {
                    return (
                      <>
                        ...
                        <br />
                        <Text className="text-gray">
                          By enabling this option, quiz taker will show
                          remaining time during attempt.
                        </Text>
                      </>
                    );
                  }}
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <>
                          ...
                          <Text className="text-gray">
                            Student have to collect this score in percent for
                            the pass this quiz.
                          </Text>
                          {errors.passingScore && (
                            <p className="error-message">
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <>
                          ...
                          />
                          <Text className="text-gray">
                            The number of questions student have to answer in
                            this quiz.
                          </Text>
                          {errors.questionsLimit && (
                            <p className="error-message">
