...
import { selectContentsById } from "redux/features/create-course/CreateCourseSelector";
...
const ContentList = ({ id }) => {
  ...
  const moveRow = useCallback(
    (dragIndex, hoverIndex) => {
      ...
      dispatch(createCourseAction.updateContentList({ data, id }));
    },
      ...
      <Modal
        ...
        footer={[
          <Button
            ...
            onClick={() => {
              dispatch(
                createCourseAction.deleteContentItem({
                  id: id,
