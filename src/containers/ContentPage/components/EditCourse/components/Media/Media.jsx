...
import { selectMedia } from "redux/features/edit-course/EditCourseSelector";
      ...
      if (!isImage) {
        ...
        uploadFile(formData)
          .then((res) => {
            ...
            dispatch(editCourseAction.addThumbnailImage(res.data.url));
      ...
      <Modal
        ...
        footer={[
          <Button
            ...
            className="btn-red"
            onClick={() => {
              dispatch(editCourseAction.deleteThumbnailImage());
              setValue("imageUrl", "");
                        ...
                        {media.localVideoUrl ? (
                          <>
                            ...
                            <div className="d-flex mg-top">
                              {parseVimeoUrl(media.localVideoUrl) ? null : (
                                <Button
