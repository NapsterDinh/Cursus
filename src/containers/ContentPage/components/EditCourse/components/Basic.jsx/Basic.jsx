...
import { schemaBasic } from "containers/ContentPage/components/CreateCourse/validate/schema";
...
import { selectBasic } from "redux/features/edit-course/EditCourseSelector";
                    ...
                    return (
                      <>
                        <Select
                          ...
                          defaultValue={basicDetail && basicDetail.categoryIds}
                        >
                          {renderCategories()}
                        </Select>
                        {errors.categoryIds && (
